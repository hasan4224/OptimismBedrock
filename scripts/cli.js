...
const contractABI = require("../artifacts/contracts/Optimismbedrock.sol/Optimismbedrock.json").abi;

program
    .name("optimismbedrock-cli")
    .description("CLI tool for Optimismbedrock smart contract")
    .version("1.0.0");
